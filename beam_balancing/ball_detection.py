    ...
    def __init__(self, config_file="config.json"):
        ...
        if os.path.exists(config_file):
            try:
                ...
                print(
                    f"[BALL_DETECT] Scale factor: {self.scale_factor:.6f} m/normalized_unit"
                )
